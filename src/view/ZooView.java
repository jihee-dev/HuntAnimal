...
public class ZooView extends JPanel {
	...
	private Image background1 = new ImageIcon(zoo.getBackgroundImg(0)).getImage(); // 버프 받았을 때 배경
	private Image background2 = new ImageIcon(zoo.getBackgroundImg(1)).getImage(); // 디버프 받았을 때 배경
	private Image bg;
